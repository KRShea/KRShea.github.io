...
Du Bois' hand drawn data graphics were included in the 1900 Paris Exposition and are still inspiring people today as made evident by Anthony Starks' <b>#DuBoisChallenge2024</b> I am participating in by means of this post.
...
<table align="center" width="100%">
  <tr>
    <td style="text-align: center;">
      <img src="/assets/post_files/dubois_challenge_2024_2/dubois_original.png" width="150" height="350" />
      <br>
      <figcaption>Original</figcaption>
    </td>
    <td style="text-align: center;">
      <img src="/assets/post_files/dubois_challenge_2024_2/post_thumbnail.png" width="150" height="350"/>
      <br>
...
When I realized that the hand drawn tear on the left was really an axis break, something you add to a chart when you need to plot small and large values in the same graph, it drove home the point just how much things changed in a short time frame in the 1860s.
...
(since Excel can't do a vertical area chart, the fill is actually a couple hundred small lines):

![Excel Little Lines](/assets/post_files/dubois_challenge_2024_2/excel_attempt_small_lines.png)

This was getting out of hand quickly and I am supposed to be learning Vega so in the end I decided to switch gears.


This chart is really a vertical area chart, which again, Excel doesn't do.  Power BI doesn't either natively, but Vega does!   
...
See my use of filter to create two distinct datasets from the original in the code below.
...
I had seen a few other people post some amazing entries of this graphic in the Du Bois challenge, but to date I haven't seen one mimicing the painted texture of the original.  I increased the opacity of the area chart and threw an MS paint image I made with the paint brush behind it.  I wasn't sure about this.  What do you think?
